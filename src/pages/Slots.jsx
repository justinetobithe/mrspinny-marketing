...
const SLOT_DATA = [
    { title: "Sweet Bonanza", tags: ["popular", "classic"], vol: 2, img: "/assets/images/games/sweet-bonanza.jpg", href: "https://mrspinny.com/games", ribbonKey: "dailyDrops", ribbonAlt: false },
    { title: "Gates of Olympus", tags: ["popular", "megaways"], vol: 3, img: "/assets/images/games/gates-of-olympus.jpg", href: "https://mrspinny.com/games" },
    { title: "5 Lions Megaways", tags: ["megaways", "new"], vol: 3, img: "/assets/images/games/5-lions-of-megaways.jpg", href: "https://mrspinny.com/games", ribbonKey: "hot", ribbonAlt: true },
    { title: "Zeus the Thunderer", tags: ["jackpot", "popular"], vol: 2, img: "/assets/images/games/thunder-olympus.jpg", href: "https://mrspinny.com/games" },
    { title: "Big Bass Bonanza", tags: ["classic", "popular"], vol: 1, img: "/assets/images/games/big-bass-bonanza.jpg", href: "https://mrspinny.com/games" },
    { title: "Book of Gold", tags: ["classic", "new"], vol: 1, img: "/assets/images/games/book-of-gold.jpg", href: "https://mrspinny.com/games" }
];
...
export default function Slots() {
    ...
    const filteredSorted = useMemo(() => {
        ...
        let list = SLOT_DATA.filter((s) => {
            ...
            const matchCat = filter === "all" ? true : filter === "fave" ? faves.has(s.title) : s.tags.includes(filter);
            return matchText && matchCat;
        });
        if (sort === "vol") list = list.slice().sort((a, b) => b.vol - a.vol);
        else if (sort === "za") list = list.slice().sort((a, b) => b.title.localeCompare(a.title));
    ...
    const onImgError = (e) => {
        ...
        el.style.background = "radial-gradient(ellipse at center,#182743 0%,#0e1730 70%)";
    };
    ...
    return (
        <main>
            <section className="hero" style={{ backgroundImage: "url('/assets/images/slots-banner.png')" }}>
                ...
                <div className="hero-content">
                    ...
                    <a
                        ...
                        onClick={() => trackClick("slots_hero_play")}
                        data-link-id="slots_hero_play"
                    >
            ...
            <section className="container slots-toolbar" aria-label={t("slots.toolbar.ariaLabel")}>
                ...
                <div className="slots-pillbar" role="tablist" aria-label={t("slots.toolbar.categoriesAria")}>
                    {pills.map(([val, label]) => (
                        <button
                            key={val}
                    ...
                    <a
                        ...
                        onClick={() => trackClick("slots_toolbar_play")}
                        data-link-id="slots_toolbar_play"
                    >
                        {t("header.cta.playNow")}
                    </a>
                </div>
            ...
            <section className="slots container">
                            ...
                            return (
                                ...
                                >
                                    <button
                                        ...
                                        aria-label={isFav ? t("slots.aria.removeFav") : t("slots.aria.addFav")}
                                        onClick={(e) => {
                                            e.preventDefault();
                                            e.stopPropagation();
                                            toggleFav(s.title);
                                    ...
                                    {s.ribbonKey && (
                                        <span className={`slot-ribbon${s.ribbonAlt ? " alt" : ""}`}>{t(`slots.ribbon.${s.ribbonKey}`)}</span>
                                    )}
                                    ...
                                    <a
                                        ...
                                        onClick={() => trackClick(`slot_open_${s.title}`)}
                                        data-link-id={`slot_open_${s.title}`}
                                    >
                                        <figure className="slot-media">
                                            <img src={s.img} alt={s.title} loading="lazy" onError={onImgError} />
                                        ...
                                        <div className="slot-info">
                                            ...
                                            <div className="slot-meta">
                                                ...
                                                <div className="slot-vol">
                                                    <span className="vol-label">{t("slots.vol.labelShort")}</span>
                                        ...
                                        <div className="slot-cta rail">
                                            <span className="btn btn-primary">{t("slots.cta.play")}</span>
                                            <span className="btn btn-outline">{t("slots.cta.demo")}</span>
                                        </div>
                                    </a>
                                </article>
                            );
                ...
                <p id="slotsEmpty" className="live-empty" hidden={filteredSorted.length !== 0}>
                    {t("slots.empty")}
                </p>
            </section>
